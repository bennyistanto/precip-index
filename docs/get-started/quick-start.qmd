...
2. **Process global data** - Use chunked processing for large datasets
3. **Read the methodology** - Understand SPI, SPEI, and run theory
4. **Explore visualizations** - Create publication-quality plots
5. **Use your own data** - Apply the package to your research
