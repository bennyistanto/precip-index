...
# Add src directory to path (relative to docs/)
...
```{python}
# Load SPI-12
ds = xr.open_dataset('../output/netcdf/spi_12_bali.nc')
...
plt.tight_layout()
plt.savefig('../output/plots/dry_vs_wet_comparison.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
plt.tight_layout()
plt.savefig('../output/plots/drought_events_timeline.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
plt.tight_layout()
plt.savefig('../output/plots/event_evolution_timeline.png', dpi=150, bbox_inches='tight')
plt.show()
```
:::
...
plt.tight_layout()
plt.savefig('../output/plots/drought_statistics_2020-2024.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
# Save drought events
drought_events.to_csv('../output/csv/drought_events_bali.csv', index=False)
print("✓ Saved drought events to ../output/csv/drought_events_bali.csv")

# Save wet events
wet_events.to_csv('../output/csv/wet_events_bali.csv', index=False)
print("✓ Saved wet events to ../output/csv/wet_events_bali.csv")

# Save time series
ts.to_csv('../output/csv/drought_timeseries_bali.csv')
print("✓ Saved time series to ../output/csv/drought_timeseries_bali.csv")
```
