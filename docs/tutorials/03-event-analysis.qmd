...
plt.tight_layout()
plt.savefig('repo_root / 'output' /plots/dry_vs_wet_comparison.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
plt.tight_layout()
plt.savefig('repo_root / 'output' /plots/drought_events_timeline.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
plt.tight_layout()
plt.savefig('repo_root / 'output' /plots/event_evolution_timeline.png', dpi=150, bbox_inches='tight')
plt.show()
```
:::
...
plt.tight_layout()
plt.savefig('repo_root / 'output' /plots/drought_statistics_2020-2024.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
os.makedirs('repo_root / 'output' /csv', exist_ok=True)
