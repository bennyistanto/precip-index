...
print("✓ Imports successful!")
print(f"Repository root: {repo_root}")
print(f"Output directories: {output_plots}, {output_netcdf}, {output_csv}")
```
...
```{python}
# Save drought events
drought_events.to_csv(output_csv / 'drought_events_bali.csv', index=False)
print(f"✓ Saved drought events to {output_csv / 'drought_events_bali.csv'}")

# Save wet events
wet_events.to_csv(output_csv / 'wet_events_bali.csv', index=False)
print(f"✓ Saved wet events to {output_csv / 'wet_events_bali.csv'}")

# Save time series
ts.to_csv(output_csv / 'drought_timeseries_bali.csv')
print(f"✓ Saved time series to {output_csv / 'drought_timeseries_bali.csv'}")
```
