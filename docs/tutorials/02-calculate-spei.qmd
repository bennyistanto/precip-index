...
By default, SPEI uses the **Gamma** distribution. For SPEI, the **Pearson III** or **Log-Logistic** distributions are recommended as they better handle the water balance data (P - PET), which can be negative:
...
See [Probability Distributions](../technical/distributions.qmd) for detailed guidance.
:::
