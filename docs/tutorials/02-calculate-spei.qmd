...
plt.tight_layout()
plt.savefig('output/plots/spei_pet_comparison.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
plt.tight_layout()
plt.savefig('output/plots/pet_vs_precipitation_maps.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
plt.tight_layout()
plt.savefig('output/plots/spi_vs_spei_comparison.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
# Save SPEI-6
save_index_to_netcdf(spei_6_with_temp, 'output/netcdf/spei_6_bali.nc', compress=True)
print("✓ Saved SPEI-6")
...
save_index_to_netcdf(spei_multi_ds, 'output/netcdf/spei_multi_scale_bali.nc', compress=True)
