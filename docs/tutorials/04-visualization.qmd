...
plt.tight_layout()
plt.savefig(output_plots / 'spi_basic.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
plt.tight_layout()
plt.savefig(output_plots / 'spi_custom.png', dpi=300, bbox_inches='tight')
plt.show()
```
...
plt.tight_layout()
plt.savefig(output_plots / 'spi_recent.png', dpi=150, bbox_inches='tight')
plt.show()
```
:::
...
plt.tight_layout()
plt.savefig(output_plots / 'drought_events_highlighted.png', dpi=150, bbox_inches='tight')
plt.show()
...
```{python}
# Plot event characteristics: Duration vs Magnitude
fig1 = plot_event_characteristics(
    drought_events,
    characteristic='magnitude',
    figsize=(12, 5)
)
plt.savefig(output_plots / 'event_duration_vs_magnitude.png', dpi=150, bbox_inches='tight')
plt.show()

# Plot event characteristics: Duration vs Intensity
fig2 = plot_event_characteristics(
    drought_events,
    characteristic='intensity',
    figsize=(12, 5)
)
plt.savefig(output_plots / 'event_duration_vs_intensity.png', dpi=150, bbox_inches='tight')
plt.show()

# Plot event characteristics: Duration
fig3 = plot_event_characteristics(
    drought_events,
    characteristic='duration',
    figsize=(12, 5)
)
plt.savefig(output_plots / 'event_characteristics.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
plt.tight_layout()
plt.savefig(output_plots / 'event_evolution_5panel.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
plt.savefig(output_plots / 'spatial_num_events.png', dpi=150, bbox_inches='tight')
plt.show()

# Plot Mean Magnitude
fig2 = plot_spatial_stats(
    stats,
...
plt.savefig(output_plots / 'spatial_mean_magnitude.png', dpi=150, bbox_inches='tight')
plt.show()

# Plot Maximum Magnitude
fig3 = plot_spatial_stats(
    stats,
...
plt.savefig(output_plots / 'spatial_statistics.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
plt.tight_layout()
plt.savefig(output_plots / 'multiscale_comparison.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
ax2.set_xlabel('Time')
plt.tight_layout()
plt.savefig(output_plots / 'dry_vs_wet_events.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
plt.tight_layout()
plt.savefig(output_plots / 'publication_quality.png',
            dpi=300,
            bbox_inches='tight',
            facecolor='white',
            edgecolor='none')
plt.savefig(output_plots / 'publication_quality.pdf',  # Vector format
            bbox_inches='tight')
plt.show()
