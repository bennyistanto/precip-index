---
title: "Climate Extremes Analysis - Run Theory"
---
...
See [Magnitude Explained](magnitude.qmd) for detailed comparison.
...
- [Magnitude Explained](magnitude.qmd) - Cumulative vs Instantaneous
- [Visualization Guide](visualization.qmd) - All plotting options
- [SPI Guide](spi.qmd) - Index calculation
- [SPEI Guide](spei.qmd) - Temperature-inclusive index
