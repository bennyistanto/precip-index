...
**Pros:** Simple, only needs mean temperature and latitude
**Cons:** Less accurate in arid/semi-arid regions
...
**Pros:** Better accuracy in arid regions, based on radiation balance
**Cons:** Requires min/max temperature data
