---
title: "Understanding Event Magnitude: Cumulative vs Instantaneous"
---
...
- [Run Theory Guide](runtheory.qmd) - Dry/wet event identification and analysis
- [Visualization Guide](visualization.qmd) - Plotting options
- [SPI Guide](spi.qmd) - Precipitation-only index
